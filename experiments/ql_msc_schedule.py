...
from sumo_framework.agents import QLAgent
from sumo_framework.exploration import EpsilonGreedy
...
if __name__ == "__main__":
    ...
    for run in range(1, runs + 1):
        ...
        for episode in range(1, episodes + 1):
            ...
            env.save_csv(f"outputs/msc_schedule/ql-msc_run{run}_{mode}_mode", episode)
