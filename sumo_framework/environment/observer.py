...
from sumo_framework.util.general_edge_utils import make_generilzed_edges
...
class AbstractObserverState:
    ...
    def encode_state(self, state):
        ...
        Returns vector representation of state. Should be present for compatibility with Env"""
        pass

    @abstractmethod
    def observe_state(self):
        """Subclasses must override this method.
        Returns state for the junctions
        Follows rules defined as limitations"""
        pass

    @abstractmethod
    def observation_spaces(self):
        """Subclasses must override this method.
        Property that defines observation space for the observer"""
        pass
...
class StateObserver(AbstractObserverState):
    ...
    def __init__(
        ...
        self.generalized_edges = make_generilzed_edges(
    ...
    def observe_state(self, sumo, subscriptions, constants):
        ...
        for tls, phases in self.tls_phases.items():
            ...
            state = phases[sumo.trafficlight.getPhase(tls)].state
